...
public class OrderService {
    ...
    /**
     * (ACID Properties)ضمان سلامة المعاملات : [Transaction Integrity - المتطلب 8]
     * هذه التعليمة تضمن أن عملية الشراء وتحديث المخزون تعمل كـ وحدة واحدة غير قابلة للتجزئة.
     *عن كل التغييرات لحماية قاعدة البيانات من أي قيم غير منطقية (Rollback) سيتم التراجع Optimistic Locking  إذا حدث تضارب بين الخيوط بسبب الـ  
     */
    @Transactional 
